...
var v = class extends HTMLElement {
	...
	renderReviewModal() {
		...
		let s = (e, t = !1) => {
			...
			let n = document.createElement("p");
			n.setAttribute("role", "status"), n.textContent = "Please wait—your NPC card is being regenerated.", n.style.cssText = "width: 100%; margin: 0.25rem 0 0; color: var(--muted-foreground); font-size: 0.75rem", e.append(n);
		...
		if (u.addEventListener("click", () => {
			...
			u.addEventListener("click", () => {
				this.resolvingReview || (u.textContent = "Regenerating…", c(l, [
					u,
					d,
					f
				]), this.submitReviewedExtraction(e, t, "regenerate"));
			...
			t.addEventListener("click", () => {
				this.resolvingReview || (t.textContent = "Regenerating…", c(o, [
					l,
					t,
					u
				]), this.submitReviewedExtraction(e, [], "regenerate"));
			}), o.append(t);
		}
