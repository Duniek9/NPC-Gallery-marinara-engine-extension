...
export declare const CONVERSATION_COMMAND_KEYS: readonly ["schedule_update", "cross_post", "selfie", "memory", "scene", "call", "uno", "chess", "poker", "eightball", "tic_tac_toe", "rock_paper_scissors", "music", "haptic", "influence", "note", "react"];
...
export declare const CONVERSATION_COMMAND_AGENT_IDS: Partial<Record<ConversationCommandKey, string>>;
...
export declare const CHAT_SUMMARY_PROMPT_SETTINGS_KEY = "chat-summary-prompts";
 ...
 */
export declare const SUMMARY_TAIL_MESSAGES: {
    readonly MIN: 0;
    readonly DEFAULT: 10;
};
export declare function normalizeSummaryTailMessages(value: unknown): number;
export declare const CHAT_SUMMARY_OUTPUT_TOKENS: {
    readonly MIN: 1;
    readonly MAX: 32768;
...
export interface ChatMetadata {
    ...
    entryStateOverrides?: Record<string, {
    ...
    conversationCharacterStatuses?: Record<string, {
        status: ConversationPresenceStatus;
        activity: string;
    }>;
...
export declare function normalizeManualTrackerAgentTypes(value: unknown): Record<string, boolean>;
