...
export type MarkerType = "character" | "lorebook" | "persona" | "chat_history" | "chat_summary" | "world_info_before" | "world_info_after" | "dialogue_examples" | "agent_data";
...
export declare const BUILTIN_MARKERS: {
    readonly MAIN: "main";
    readonly NSFW: "nsfw";
    readonly JAILBREAK: "jailbreak";
    readonly ENHANCE_DEFINITIONS: "enhanceDefinitions";
    readonly CHAR_DESCRIPTION: "charDescription";
    readonly CHAR_PERSONALITY: "charPersonality";
    readonly SCENARIO: "scenario";
    readonly PERSONA_DESCRIPTION: "personaDescription";
    readonly DIALOGUE_EXAMPLES: "dialogueExamples";
    readonly CHAT_HISTORY: "chatHistory";
    readonly WORLD_INFO_BEFORE: "worldInfoBefore";
    readonly WORLD_INFO_AFTER: "worldInfoAfter";
};
