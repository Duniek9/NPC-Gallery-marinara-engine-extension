...
export function resolveOpenAIGpt56ModelForRequest(model) {
...
export function resolveProviderReasoningEffort(args) {
    ...
    const xaiUsesAutoReasoning = (providerLower === "xai" && isXaiAutoReasoningModel(modelLower)) ||
...
export const VIDEO_GENERATION_SOURCES = [
    {
        id: "google_ai_studio",
...
function normalizeProviderForCatalog(provider) {
    ...
    return normalized in MODEL_LISTS ? normalized : null;
}
export function shouldSuppressUnknownModelParameters(provider, modelId) {
