...
export function ChatSettingsDrawer({
  ...
  const featureSettingsPackageByAgentId = useMemo(() => {
    ...
    for (const item of installedCapabilities) {
      ...
      for (const agentId of item.manifest.contributions.agentDetail?.agentIds ?? []) packages.set(agentId, item);
    }
    return packages;
                                    ...
                                    {activeInCat.map((agent) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          ...
                                          {featureSettingsPackage && featureSettingsPackage.id !== mapsPackage?.id && (
                                            <CapabilityElement
