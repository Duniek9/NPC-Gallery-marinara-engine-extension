    ...
    onComplete(
      {
        ...
        partyCharacterIds,
        activeAgentIds: enableNpcGallery ? ["npc-gallery"] : undefined,
              ...
              <div className="space-y-2">
                ...
                {npcGalleryInstalled && (
                  <div className="rounded-lg bg-[var(--secondary)] ring-1 ring-transparent">
                    <button
                      type="button"
                      onClick={() => setEnableNpcGallery((previous) => !previous)}
                      className="flex w-full items-center justify-between gap-3 rounded-lg px-3 py-2.5 text-left"
                    >
                      <div>
                        <span className="block text-xs font-medium text-[var(--foreground)]">NPC Gallery</span>
                        <span className="block text-[0.575rem] text-[var(--muted-foreground)]">
                          Import generated starting NPCs and optionally ground this world in selected gallery NPCs
                        </span>
                      </div>
                      <span className={cn("text-[0.625rem]", enableNpcGallery ? "text-[var(--primary)]" : "text-[var(--muted-foreground)]")}>
