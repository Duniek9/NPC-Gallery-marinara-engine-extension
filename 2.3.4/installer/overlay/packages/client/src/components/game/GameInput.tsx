...
interface GameInputProps {
  ...
  npcGalleryCapabilityEnabled?: boolean;
  /**
...
export function GameInput({
  ...
  npcGalleryCapabilityEnabled = false,
  interruptMode,
}: GameInputProps) {
  ...
  return (
    ...
    >
      ...
      {npcGalleryCapabilityEnabled && draftKey ? (
        <CapabilityElement
          packageId="npc-gallery"
          view="runtime"
          capabilityProps={{ chatId: draftKey, chatMode: "game", enabledForChat: true }}
          className="contents"
        />
      ) : null}
