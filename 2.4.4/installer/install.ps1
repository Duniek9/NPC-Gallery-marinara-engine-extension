...
$RequiredEngineVersion = "2.4.4"
$IntegrationVersion = "1.3.0"
$BackupFolderName = ".npc-gallery-engine-backups/2.4.4"
    ...
    try {
      ...
      try {
        ...
        if (Test-Path -LiteralPath $SharedEntry -PathType Leaf) {
          ...
          throw "Shared compilation failed and produced no Marinara 2.4.4 runtime output."
        }
      }
    }
  }
...
$UpdaterSource = Join-Path $ExtensionRoot "updater\reconcile.mjs"
