...
var v = class extends HTMLElement {
	...
	connectedCallback() {
		this.addEventListener("marinara-capability-props", this.handleCapabilityProps), this.handleCapabilityProps(), this.restoreNpcDraft(), this.render(), this.loadSettings(), this.getAttribute("view") === "runtime" && (this.pendingPoll = window.setInterval(() => void this.pollPendingExtractions(), 2e3));
	}
