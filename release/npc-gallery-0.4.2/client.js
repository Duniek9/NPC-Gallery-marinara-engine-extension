...
var v = class extends HTMLElement {
	...
	render() {
		...
		O.textContent = this.errorMessage, O.style.cssText = "margin: 0.5rem 0 0; color: var(--destructive); font-size: 0.75rem", t.append(n, i), this.activeView === "gallery" ? t.append(this.renderGallery()) : t.append(a, o, u, g, y), this.deletingFolder && t.append(this.renderFolderDeleteModal()), this.errorMessage && t.append(O), this.append(t);
	}
};
