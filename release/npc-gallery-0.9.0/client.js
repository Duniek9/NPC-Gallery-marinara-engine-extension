...
var v = class extends HTMLElement {
	...
	renderReviewModal() {
		...
		}, c = s("Accept checked", !0), l = s("Review later");
		return l.addEventListener("click", () => {
			...
			c.style.cssText = "display: flex; flex-wrap: wrap; gap: 0.5rem; margin-top: 1rem";
			let l = s("Regenerate unchecked", !0), u = s("Abandon unchecked"), d = s("Go back");
			l.addEventListener("click", () => void this.submitReviewedExtraction(e, t, "regenerate")), u.addEventListener("click", () => void this.submitReviewedExtraction(e, t, "abandon")), d.addEventListener("click", () => this.render()), c.append(l, u, d), n.append(i, o, c);
		}), o.append(c, l), n.append(o), t.append(n), t;
	}
	renderGallery() {
