...
import {
  registerAssistantMessageObserver,
  type AssistantMessageObserver,
} from "./assistant-message-observer.service.js";
import {
  registerGameSetupCompletedObserver,
  registerGameSetupContextContributor,
  type GameSetupCompletedObserver,
  type GameSetupContextContributor,
} from "./game-setup-observer.service.js";
import {
  registerGenerationContextContributor,
  type GenerationContextContributor,
} from "./generation-context-contributor.service.js";
...
type CapabilityActivationContext = {
  ...
  registerConversationCommand(registration: CapabilityConversationCommandRegistration): Cleanup;
    ...
    registerAssistantMessageObserver(observer: AssistantMessageObserver): Cleanup;
    registerGameSetupContextContributor(contributor: GameSetupContextContributor): Cleanup;
    registerGameSetupCompletedObserver(observer: GameSetupCompletedObserver): Cleanup;
    registerGenerationContextContributor(contributor: GenerationContextContributor): Cleanup;
    ...
    try {
      ...
      const context: CapabilityActivationContext = {
        ...
        api: {
          ...
          registerAssistantMessageObserver: (observer) => trackCleanup(registerAssistantMessageObserver(observer)),
          registerGameSetupContextContributor: (contributor) =>
            trackCleanup(registerGameSetupContextContributor(installed.id, contributor)),
          registerGameSetupCompletedObserver: (observer) =>
            trackCleanup(registerGameSetupCompletedObserver(installed.id, observer)),
          registerGenerationContextContributor: (contributor) =>
            trackCleanup(registerGenerationContextContributor(installed.id, contributor)),
