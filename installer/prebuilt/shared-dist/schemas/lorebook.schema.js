...
export const LOREBOOK_CATEGORY_VALUES = ["world", "character", "npc", "spellbook", "uncategorized"];
export const lorebookCategorySchema = z.enum(LOREBOOK_CATEGORY_VALUES);
export function normalizeLorebookCategory(value) {
...
function addLorebookScopeConflictIssues(value, ctx) {
...
//# sourceMappingURL=lorebook.schema.js.map