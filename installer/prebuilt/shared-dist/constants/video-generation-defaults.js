...
export const VIDEO_GENERATION_DEFAULTS_VERSION = 1;
export const VIDEO_DEFAULTS_SERVICES = [
    "gemini_omni",
    "google_veo",
    "xai",
    "openrouter",
...
export const DEFAULT_GEMINI_OMNI_VIDEO_DEFAULTS = {
    durationSeconds: 10,
    aspectRatio: "16:9",
};
export const DEFAULT_XAI_VIDEO_DEFAULTS = {
    durationSeconds: 10,
    aspectRatio: "16:9",
    resolution: "720p",
};
export const DEFAULT_GOOGLE_VEO_VIDEO_DEFAULTS = {
    durationSeconds: 8,
    aspectRatio: "16:9",
    resolution: "720p",
};
export const DEFAULT_OPENROUTER_VIDEO_DEFAULTS = {
    durationSeconds: 10,
    aspectRatio: "16:9",
    resolution: "720p",
};
export const DEFAULT_SEEDANCE_VIDEO_DEFAULTS = {
    durationSeconds: 5,
    aspectRatio: "16:9",
    resolution: "720p",
...
export const DEFAULT_COMFYUI_VIDEO_DEFAULTS = {
    durationSeconds: 5,
    aspectRatio: "16:9",
    resolution: "720p",
};
export function createDefaultVideoGenerationProfile(service = "gemini_omni") {
    return {
...
export function normalizeVideoGenerationProfile(rawProfile) {
    ...
    profile.openrouter = {
        durationSeconds: readInteger(rawOpenRouter.durationSeconds, DEFAULT_OPENROUTER_VIDEO_DEFAULTS.durationSeconds, 1, 60),
    ...
    profile.seedance = {
        ...
        temporaryPublicReferenceUploadEnabled: readBoolean(rawSeedance.temporaryPublicReferenceUploadEnabled, DEFAULT_SEEDANCE_VIDEO_DEFAULTS.temporaryPublicReferenceUploadEnabled),
        temporaryPublicReferenceUploadExpiry: readReferenceUploadExpiry(rawSeedance.temporaryPublicReferenceUploadExpiry, DEFAULT_SEEDANCE_VIDEO_DEFAULTS.temporaryPublicReferenceUploadExpiry),
    };
...
export function sanitizeVideoGenerationProfile(profile) {
...
function readVeoDuration(value, fallback) {
    const numeric = typeof value === "number" ? value : typeof value === "string" ? Number(value) : NaN;
    if (!Number.isFinite(numeric))
        return fallback <= 5 ? 4 : fallback <= 7 ? 6 : 8;
    if (numeric <= 5)
        return 4;
    if (numeric <= 7)
        return 6;
...
function readAspectRatio(value, fallback) {
    return value === "9:16" || value === "16:9" ? value : fallback;
}
function readResolution(value, fallback) {
    return value === "480p" || value === "720p" || value === "1080p" ? value : fallback;
}
function readReferenceUploadExpiry(value, fallback) {
    return value === "1h" || value === "12h" || value === "24h" || value === "72h" ? value : fallback;
}
//# sourceMappingURL=video-generation-defaults.js.map