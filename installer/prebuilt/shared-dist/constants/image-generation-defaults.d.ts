...
export declare const COMFYUI_PLACEHOLDER_REFERENCE_BASE64 = "";
...
export declare const SD_WEBUI_SAMPLER_OPTIONS: readonly [{
    ...
    readonly value: "PLMS";
    readonly label: "PLMS (Draw Things)";
}, {
    readonly value: "LCM";
    readonly label: "LCM (Draw Things)";
}, {
    readonly value: "TCD";
    readonly label: "TCD (Draw Things)";
}, {
    readonly value: "TCD Trailing";
    readonly label: "TCD Trailing (Draw Things)";
}, {
    readonly value: "Euler A Substep";
    readonly label: "Euler A Substep (Draw Things)";
}, {
    readonly value: "DPM++ SDE Substep";
    readonly label: "DPM++ SDE Substep (Draw Things)";
}, {
    readonly value: "Euler A Trailing";
    readonly label: "Euler A Trailing (Draw Things)";
}, {
    readonly value: "DPM++ SDE Trailing";
    readonly label: "DPM++ SDE Trailing (Draw Things)";
}, {
    readonly value: "DPM++ 2M Trailing";
    readonly label: "DPM++ 2M Trailing (Draw Things)";
}, {
    readonly value: "DDIM Trailing";
    readonly label: "DDIM Trailing (Draw Things)";
}, {
    readonly value: "UniPC Trailing";
    readonly label: "UniPC Trailing (Draw Things)";
}, {
    readonly value: "Euler A AYS";
    readonly label: "Euler A AYS (Draw Things)";
}, {
    readonly value: "DPM++ 2M AYS";
    readonly label: "DPM++ 2M AYS (Draw Things)";
}, {
    readonly value: "DPM++ SDE AYS";
    readonly label: "DPM++ SDE AYS (Draw Things)";
}, {
    readonly value: "UniPC AYS";
    readonly label: "UniPC AYS (Draw Things)";
}];
